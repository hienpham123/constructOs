...
class __TwigTemplate_805156887e5bb18dacc1bf741b0249bb extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "/Users/hochihien/Code/constructOS/database/phpmyadmin/templates/database/export/index.twig");
    }
}
